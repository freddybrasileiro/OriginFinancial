        ...
        <Card>
            <S.SimulationResult>
                ...
                <div className="details-line">
                    <Text variant="body5">
                        You’re planning <Text variant="body6">{months} monthly deposits</Text> to reach your <Text variant="body6">${totalAmount}</Text> goal by <Text variant="body6">{monthNames[reachGoalBy[0]]} {reachGoalBy[1]}</Text>.
                    </Text>
                </div>
            </S.SimulationResult>
        </Card>
